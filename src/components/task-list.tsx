...
import { ScrollView, PanGestureHandlerProps } from 'react-native-gesture-handler';
...
export default function AnimatedTaskItemList(props: TaskListProps) {
  const { data, editingItemId, onChangeSubject, onFinishEditing, onPressLabel, onRemoveItem, onToggleItem } = props;
